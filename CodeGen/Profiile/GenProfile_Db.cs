...
public class GenProfile_Db
{
    public static string Do(ProfileConfig profileConfig)
    {
    ...
    public static void Gen_DeepCopyFrom_Db(FileFormatter f, ProfileConfig profileConfig)
    {
