namespace Data
{
    public enum MsgType
    {
        ...
        _Room_SaveSceneRoomInfoToFile = 603,
        ...
        _Query_SceneRoomInfo_by_roomId = 5009,
        _Query_SceneRoomInfo_maxOf_roomId = 5010,
        _Insert_SceneRoomInfo = 5011,
        _Save_SceneRoomInfo = 5012,
        _Search_SceneRoomInfo = 5013,
        _Save_MessageReportInfo = 5014,
        _Save_UserReportInfo = 5015,
        _Save_UserBriefInfo = 5016,
        _Query_UserBriefInfo_by_userId = 5017,
        _Query_FriendChatRoomInfo_by_roomId = 5018,
        _Query_FriendChatRoomInfo_maxOf_roomId = 5019,
        _Insert_FriendChatRoomInfo = 5020,
        _Save_FriendChatRoomInfo = 5021,
        _Query_FriendChatMessages_by_roomId_receivedSeqs = 5023,
        ClientStart = 10000,
        Forward = 10001,
        Login = 10002,
        Kick = 10003,
