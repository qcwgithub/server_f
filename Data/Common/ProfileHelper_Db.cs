...
public static class ProfileHelper_Db
{
    ...
    public static List<T> Copy_ListValue<T>(List<T> other)
    {
        ...
        var self = new List<T>();
        ProfileHelper.DeepCopyFrom_ListValue(self, other);
        return self;
    }
    ...
    public static HashSet<T> Copy_HashSetValue<T>(HashSet<T> other)
    {
        ...
        ProfileHelper.DeepCopyFrom_HashSetValue(self, other);
        return self;
    }
    ...
    public static Dictionary<K, V> Copy_DictValue<K, V>(Dictionary<K, V> other)
    {
        ...
        ProfileHelper.DeepCopyFrom_DictValue(self, other);
        return self;
    }
