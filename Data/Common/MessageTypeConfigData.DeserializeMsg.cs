        ...
        public static object DeserializeMsg(MsgType msgType, byte[] msgBytes)
        {
            ...
            switch (msgType)
            {
                ...
                case MsgType._Room_SaveSceneRoomInfoToFile:
                    ob = MessagePackSerializer.Deserialize<MsgSaveSceneRoomInfoToFile>(msgBytes);
                    break;
                ...
                case MsgType._Query_SceneRoomInfo_by_roomId:
                    ob = MessagePackSerializer.Deserialize<MsgQuery_SceneRoomInfo_by_roomId>(msgBytes);
                    break;

                case MsgType._Query_SceneRoomInfo_maxOf_roomId:
                    ob = MessagePackSerializer.Deserialize<MsgQuery_SceneRoomInfo_maxOf_roomId>(msgBytes);
                    break;

                case MsgType._Insert_SceneRoomInfo:
                    ob = MessagePackSerializer.Deserialize<MsgInsert_SceneRoomInfo>(msgBytes);
                    break;

                case MsgType._Save_SceneRoomInfo:
                    ob = MessagePackSerializer.Deserialize<MsgSave_SceneRoomInfo>(msgBytes);
                    break;

                case MsgType._Search_SceneRoomInfo:
                    ob = MessagePackSerializer.Deserialize<MsgSearch_SceneRoomInfo>(msgBytes);
                    break;
                ...
                case MsgType._Query_FriendChatRoomInfo_by_roomId:
                    ob = MessagePackSerializer.Deserialize<MsgQuery_FriendChatRoomInfo_by_roomId>(msgBytes);
                    break;

                case MsgType._Query_FriendChatRoomInfo_maxOf_roomId:
                    ob = MessagePackSerializer.Deserialize<MsgQuery_FriendChatRoomInfo_maxOf_roomId>(msgBytes);
                    break;

                case MsgType._Insert_FriendChatRoomInfo:
                    ob = MessagePackSerializer.Deserialize<MsgInsert_FriendChatRoomInfo>(msgBytes);
                    break;

                case MsgType._Save_FriendChatRoomInfo:
                    ob = MessagePackSerializer.Deserialize<MsgSave_FriendChatRoomInfo>(msgBytes);
                    break;

                case MsgType._Query_FriendChatMessages_by_roomId_receivedSeqs:
                    ob = MessagePackSerializer.Deserialize<MsgQuery_FriendChatMessages_by_roomId_receivedSeqs>(msgBytes);
                    break;
                ...
                case MsgType.ReceiveFriendChatMessages:
                    ob = MessagePackSerializer.Deserialize<MsgReceiveFriendChatMessages>(msgBytes);
                    break;

                case MsgType.SetFriendChatReadSeq:
                    ob = MessagePackSerializer.Deserialize<MsgSetFriendChatReadSeq>(msgBytes);
                    break;

                case MsgType.SetFriendChatReceivedSeq:
                    ob = MessagePackSerializer.Deserialize<MsgSetFriendChatReceivedSeq>(msgBytes);
                    break;
