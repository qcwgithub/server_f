...
namespace Script
{
    ...
    public sealed class Query_AccountInfo_by_channel_channelUserId : Handler<DbService, MsgQuery_AccountInfo_by_channel_channelUserId, ResQuery_AccountInfo_by_channel_channelUserId>
    {
        ...
        public override async Task<ECode> Handle(IConnection connection, MsgQuery_AccountInfo_by_channel_channelUserId msg, ResQuery_AccountInfo_by_channel_channelUserId res)
        {
