...
public class collection_user_info : ServiceScript<DbService>
{
    ...
    public async Task CreateIndex()
    {
        await MongoHelper.CreateIndex(this.mongoClient, this.dbName, COLLECTION,
            nameof(UserInfo.userId), true, true, this.service.logger);

        // RegularSearchByName 要用到
        await MongoHelper.CreateIndex(this.mongoClient, this.dbName, COLLECTION,
            nameof(UserInfo.userName), true, false, this.service.logger);
    }
