...
namespace Script
{
    ...
    public sealed class Query_AccountInfo_byElementOf_userIds : Handler<DbService, MsgQuery_AccountInfo_byElementOf_userIds, ResQuery_AccountInfo_byElementOf_userIds>
    {
        ...
        public override async Task<ECode> Handle(IConnection connection, MsgQuery_AccountInfo_byElementOf_userIds msg, ResQuery_AccountInfo_byElementOf_userIds res)
        {
