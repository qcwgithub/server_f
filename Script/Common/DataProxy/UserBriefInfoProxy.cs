...
{
    //// AUTO CREATED ////
    public sealed class UserBriefInfoProxy : DataProxy<UserBriefInfo, long, int>
    {
        //// AUTO CREATED ////
        public UserBriefInfoProxy(Server server) : base(server)
        {
        }
        ...
        {
            return stDirtyElement.Create_UserBriefInfo(userId);
        }
        ...
        {
            return LockKey.LoadDataFromDBToRedis.UserBriefInfo(userId);
        }

        //// AUTO CREATED ////
        protected override async Task<(ECode, UserBriefInfo)> LoadFromDB(DbServiceProxy dbServiceProxy, long userId, int _2 = 0)
        {
            var msgDb = new MsgQuery_UserBriefInfo_by_userId();
            msgDb.userId = userId;
            var r = await dbServiceProxy.Query_UserBriefInfo_by_userId(msgDb);
        ...
        /////////////////////////////////////////// PUBLIC ///////////////////////////////////////////
        //// AUTO CREATED ////
        public async Task<UserBriefInfo> Get(DbServiceProxy DbServiceProxy, long userId)
        {
            if (userId == 0)
            {
        ...
        //// AUTO CREATED ////
        public async Task Save(UserBriefInfo info)
        {
