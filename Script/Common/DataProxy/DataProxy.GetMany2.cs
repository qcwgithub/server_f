...
namespace Script
{
    ...
    {
        public async Task<List<DataType>> GetManyHelp(ConnectToDBPlayerService connectToDBPlayerService, P1 p1, List<P2> p2s)
        {
            ...
            for (int i = 0; i < values.Length; i++)
            {
                ...
                else
                {
                    ...
                    tasks.Add(this.InternalGet(connectToDBPlayerService, p1, p2s[i]));
                    indexes.Add(i);
                }
            }
        ...
        public async Task<List<DataType>> GetMany(ConnectToDBPlayerService connectToDBPlayerService, P1 p1, List<P2> p2s, bool fillNullIfNotExist)
        {
            var list2 = await this.GetManyHelp(connectToDBPlayerService, p1, p2s);
