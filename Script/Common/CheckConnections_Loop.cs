...
namespace Script
{
    ...
    public class CheckConnections_Loop<S> : Handler<S, MsgCheckConnections_Loop>
        where S : Service
    {
        ...
        public override async Task<MyResponse> Handle(ProtocolClientData _socket/* null */, MsgCheckConnections_Loop msg)
        {
