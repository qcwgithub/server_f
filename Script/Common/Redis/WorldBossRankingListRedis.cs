...
namespace Script
{
    public abstract class BaseWorldBossRankingListRedis : WaitInitDataRedis_ServerId<NormalServer>
    {
        ...
        public override string WaitKey(int serverId) => GlobalKey.WorldBossInitedFlag(serverId);
    ...
    public class WorldBossRankingListRedis : BaseWorldBossRankingListRedis
    {
        public override string Key(stParentServerId parentServerId) => WorldBossKey.RankingList(parentServerId);
    }

    public class TempWorldBossRankingListRedis : BaseWorldBossRankingListRedis
    {
        public override string Key(stParentServerId parentServerId) => TemporaryKey.ToTemporaryKey(WorldBossKey.RankingList(parentServerId), "forSumUp");
    }
}