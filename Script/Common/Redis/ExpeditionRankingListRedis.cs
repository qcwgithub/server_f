...
namespace Script
{
    public abstract class BaseExpeditionRankingListRedis : WaitInitDataRedis_ServerId<NormalServer>
    {
    ...
    public class ExpeditionRankingListRedis : BaseExpeditionRankingListRedis
    {
        public override string Key(stParentServerId parentServerId) => ExpeditionKey.RankingList(parentServerId);
    }

    public class TempExpeditionRankingListRedis : BaseExpeditionRankingListRedis
    {
        public override string Key(stParentServerId parentServerId) => TemporaryKey.ToTemporaryKey(ExpeditionKey.RankingList(parentServerId), "forSumUp");
    }
}