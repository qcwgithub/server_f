...
namespace Script
{
    public abstract class BaseRushRankingListRedis : WaitInitDataRedis_ServerId<NormalServer>
    {
        ...
        public override string WaitKey(int serverId) => GlobalKey.RushInitedFlag(serverId);
    ...
    public class RushRankingListRedis : BaseRushRankingListRedis
    {
        public override string Key(int serverId) => RushKey.RankingList(serverId);
    }

    public class TempRushRankingListRedis : BaseRushRankingListRedis
    {
        public override string Key(int serverId) => TemporaryKey.ToTemporaryKey(RushKey.RankingList(serverId), "forSumUp");
    }
}