...
namespace Script
{
    public abstract class BaseCarnivalRankingListRedis : WaitInitDataRedis_ServerId<NormalServer>
    {
        ...
        public override string WaitKey(int serverId) => GlobalKey.CarnivalInitedFlag(serverId);
    ...
    public class CarnivalRankingListRedis : BaseCarnivalRankingListRedis
    {
        public override string Key(stParentServerId parentServerId) => CarnivalKey.RankingList(parentServerId);
    }

    public class TempCarnivalRankingListRedis : BaseCarnivalRankingListRedis
    {
        public override string Key(stParentServerId parentServerId) => TemporaryKey.ToTemporaryKey(CarnivalKey.RankingList(parentServerId), "forSumUp");
    }
}