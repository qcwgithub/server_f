...
namespace Script
{
    public abstract class BaseExperienceRankingListRedis : WaitInitDataRedis_ServerId<NormalServer>
    {
        ...
        public override string WaitKey(int serverId) => GlobalKey.ExperienceInitedFlag(serverId);
    ...
    public class ExperienceRankingListRedis : BaseExperienceRankingListRedis
    {
        public override string Key(int serverId) => ExperienceKey.RankingList(serverId);
    }

    public class TempExperienceRankingListRedis : BaseExperienceRankingListRedis
    {
        public override string Key(int serverId) => TemporaryKey.ToTemporaryKey(ExperienceKey.RankingList(serverId), "forSumUp");
    }
}