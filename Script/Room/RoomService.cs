...
namespace Script
{
    public partial class RoomService : Service
    {
        ...
        public readonly RoomMessageIdSnowflakeScript roomMessageIdSnowflakeScript;
        ...
        public RoomService(Server server, int serviceId) : base(server, serviceId)
        {
            ...
            this.roomMessageIdSnowflakeScript = new RoomMessageIdSnowflakeScript(this.server, this);
        ...
        public override void Attach()
        {
            ...
            this.dispatcher.AddHandler(new Room_UserEnter(this.server, this));
            this.dispatcher.AddHandler(new Room_UserLeave(this.server, this));
        }
